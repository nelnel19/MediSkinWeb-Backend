...
export const se_DeleteProcessingJobCommand = async (input, context) => {
    const headers = sharedHeaders("DeleteProcessingJob");
    let body;
    body = JSON.stringify(_json(input));
    return buildHttpRpcRequest(context, headers, "/", undefined, body);
};
...
export const se_DeleteTrainingJobCommand = async (input, context) => {
    const headers = sharedHeaders("DeleteTrainingJob");
    let body;
    body = JSON.stringify(_json(input));
    return buildHttpRpcRequest(context, headers, "/", undefined, body);
};
...
export const de_DeleteProcessingJobCommand = async (output, context) => {
    if (output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    await collectBody(output.body, context);
...
export const de_DeleteTrainingJobCommand = async (output, context) => {
    if (output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    await collectBody(output.body, context);
